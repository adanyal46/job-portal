...
const MentorServices = () => {
              ...
              },
              {
                ...
                onClick: () => {
                  Modal.confirm({
                    ...
                    onOk() {
                      try {
                        dispatch(deleteMentorService(record?.id));
                        message.open({
                          type: "success",
                          content: "Mentor Service Deleted",
                        });
                      } catch (error) {
  ...
  const handleADD = async () => {
    try {
      ...
      dispatch(addMentorService(values));
      handleClose();
      message.open({
        type: "success",
        content: "Mentor Service Created",
      });
    } catch (error) {
      message.error(error.message || "Internal Server Error");
    }
  ...
  const handleUpdate = async () => {
    try {
      await form.validateFields();
      const values = form.getFieldsValue();
      dispatch(updateMentorService({ id: industryId, data: values }));
      handleClose();
      message.open({
        type: "success",
        content: "Mentor Service Updated",
      });
    } catch (error) {
      message.error(error.message || "Internal Server Error");
    }
