  ...
  return (
    <Switch>
      ...
      <Case condition={category === "danger"}>
        <Button danger type="text" className={`common-button-styles custom-button-danger ${classes}`} onClick={onClick} loading={loading}>
          {name}
        </Button>
      </Case>
      ...
      <Case condition={category === "additional"}>
        <Button className={`additional-button ${classes} ${disabled && "additional-button-disabled"}`} disabled={disabled} onClick={onClick}>
      ...
      <Case condition={category === "iconed"}>
        <Button className={`custom-iconed-button ${classes}`} shape={shape} icon={icon} onClick={onClick} disabled={disabled} />
      </Case>

      <Default>
        <Button type={type} className={`custom-button ${classes}`} onClick={onClick}>
          {name}
        </Button>
      </Default>
    </Switch>
