...
const NotificationEmptyScreen = () => (
    <section className="empty-notifications-container">
        <figure className="no-notification-container">
            <img loading="lazy" src="/images/empty-notifications.png" className="no-notification-image"
                 alt="NoNotifications"/>
        </figure>
    </section>
);
                    ...
                    {recruiterApprovalStatus === "PENDING" && (
                        <>
                            ...
                            <Flex gap={"small"} style={{marginBottom: "10px"}}>
                                ...
                                <CustomButton category="plain" name="View"
                                              handleClick={() => onViewClick(notificationData.id)}
                    ...
                    <div style={{borderBottom: "1px solid #e8e8e8", paddingBottom: "10px", marginBottom: "10px"}}>
                        <Typography.Paragraph style={{margin: 0}}>
                            ...
                            <span style={{
                                marginLeft: "8px",
                                color: "#595959"
                            }}>{new Date(job.startDate).toLocaleDateString()}</span>
                        </Typography.Paragraph>
                    </div>
                    <div>
                        <Typography.Paragraph style={{margin: 0}}>
                            ...
                            <span style={{
                                marginLeft: "8px",
                                color: "#595959"
                            }}>{new Date(job.endDate).toLocaleDateString()}</span>
                        </Typography.Paragraph>
                    </div>
                </Card>
            ),
